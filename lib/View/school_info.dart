      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            reusableTextField(
                viewModel.getSchoolInfo.name , Icons.school),
            const SizedBox(
              height: 15,
            ),
            reusableTextField(viewModel.getSchoolInfo.address,
                Icons.location_on_rounded),
            const SizedBox(
              height: 15,
            ),
            reusableTextField(viewModel.getSchoolInfo.noStudents,
                Icons.person),
            const SizedBox(
              height: 15,
            ),
            reusableTextField(viewModel.getSchoolInfo.noTeachers,
                Icons.person),
            Padding(
